    ...
    <>
      <section className="overflow-hidden pb-20 pt-35 md:pt-40 xl:pb-25 xl:pt-46">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          <div className="flex sm:flex-col sm:gap-0 lg:items-center lg:gap-4 xl:gap-16.5">
            <div className="sm:w-full md:w-1/2">
              <h3 className="mb-4.5 text-xl font-medium text-black dark:text-white">
            ...
            <div className="animate_right sm:w-full md:w-1/2 lg:block">
